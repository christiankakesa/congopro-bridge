...
2. **Trust & revenue plumbing** — ✅ **customer email-OTP auth shipped** (2026-08-18: `/account` login, `internal/customers`, migration 00003; verified end-to-end against OVH EmailPro and Mailpit). Also shipped: company claim/dispute workflow with an admin queue (2026-08-24). Remaining: ads CMS with sales-rep attribution.
