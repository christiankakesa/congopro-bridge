...
func main() {
	...
	mux.HandleFunc("GET /admin", apiAppEngine.WithSecurityHeaders(apiAppEngine.RequireStaffAuth(apiAppEngine.AdminDashboardHandler)))
	mux.HandleFunc("GET /admin/companies", apiAppEngine.WithSecurityHeaders(apiAppEngine.RequireStaffAuth(apiAppEngine.AdminCompaniesListHandler)))
