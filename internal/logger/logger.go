...
var skippedPaths = []string{"/api/v1/healthz", "/favicon.ico", "/fonts/", "/css/", "/images/"}

// AccessLogMiddleware attaches structured HTTP access logging to a handler chain.
// Skips logging for the /api/v1/healthz endpoint to avoid noise in monitoring dashboards.
